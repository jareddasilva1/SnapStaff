...
#import "ViewStaffTVC.h"
#import "ViewStaffTableViewCell.h"

@interface ViewStaffTVC ()

@end

@implementation ViewStaffTVC
...
- (void)viewDidLoad {
    ...
    if (sharedData.detailsType == VIEWREPORT) {
         self.title = [NSString stringWithFormat:@"Event Reports"];
        ...
        self.navigationItem.rightBarButtonItem = btnNext;
          ...
          self.title = [NSString stringWithFormat:@"Staff X/X"];
    }
}
...
-(void) editAccount
{
    UIActionSheet *actionSheet = [[UIActionSheet alloc] initWithTitle:@"What do you want to do with the reports?"
                                                             delegate:self
                                                    cancelButtonTitle:@"Cancel"
                                               destructiveButtonTitle:nil
                                                    otherButtonTitles:@"Export All", nil];
